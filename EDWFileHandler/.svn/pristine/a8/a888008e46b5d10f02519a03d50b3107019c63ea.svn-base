...
namespace EDWFileHandler
{
    ...
    public partial class DATATRANSFEREDWRES
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public DATATRANSFEREDWRES()
        {
            this.AIRTRACKRES = new HashSet<AIRTRACKRES>();
        }
        ...
        public virtual ICollection<AIRTRACKRES> AIRTRACKRES { get; set; }
    }
}
